...
// Safely replace within language blocks
transJs = transJs.replace(/en: \{([\s\S]*?)navContactMobile: "Let's Talk",/g, "en: {$1navContactMobile: \"Let's Talk\",\n" + enAdditions);
transJs = transJs.replace(/ar: \{([\s\S]*?)navContactMobile: "تواصل معنا",/g, "ar: {$1navContactMobile: \"تواصل معنا\",\n" + arAdditions);
transJs = transJs.replace(/fr: \{([\s\S]*?)navContactMobile: "Contact",/g, "fr: {$1navContactMobile: \"Contact\",\n" + frAdditions);
transJs = transJs.replace(/nl: \{([\s\S]*?)navContactMobile: "Contact",/g, "nl: {$1navContactMobile: \"Contact\",\n" + nlAdditions);
